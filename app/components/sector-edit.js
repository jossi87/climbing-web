            ...
            <FormGroup controlId="formControlsMap">
              ...
              <section style={{height: '600px'}}>
                <GettingStartedGoogleMap
                  ...
                  markers={this.state.lat!=0 && this.state.lng!=0? <Marker position={{lat: this.state.lat, lng: this.state.lng}} icon={{url: 'https://maps.google.com/mapfiles/kml/shapes/parking_lot_maps.png', scaledSizeW: 32, scaledSizeH: 32}}/> : ""}
                  outline={outline}
                />
              </section>
            </FormGroup>
