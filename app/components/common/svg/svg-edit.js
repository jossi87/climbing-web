        ...
        <Well bsSize="small" onMouseUp={this.cancelDragging.bind(this)} onMouseLeave={this.cancelDragging.bind(this)}>
          <form onSubmit={this.save.bind(this)}>
            ...
            <FormGroup controlId="formControlsImage">
              <svg className="buldreinfo-svg" viewBox={"0 0 " + this.state.w + " " + this.state.h} onClick={this.addPoint.bind(this)} onMouseMove={this.handleMouseMove.bind(this)} preserveAspectRatio="xMinYMin slice">
