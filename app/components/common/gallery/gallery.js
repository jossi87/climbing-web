...
export default class Gallery extends Component {
  ...
  generateShapes(svgs, svgProblemId, w, h) {
    return svgs.map((svg, key) => {
      ...
      return (
        <g className={"buldreinfo-svg-hover buldreinfo-svg-pointer" + ((svgProblemId===0 || svg.problemId===svgProblemId)? "" : " buldreinfo-svg-opacity")} key={key} onClick={this.pushUrl.bind(this, "/problem/" + svg.problemId)}>
