...
export const designContract = {
  ...
  controls: {
    ...
    tabBarButtonActive:
      'bg-transparent text-slate-50 after:pointer-events-none after:absolute after:bottom-[-1px] after:left-1/2 after:h-[3px] after:w-[min(5.75rem,calc(100%-0.75rem))] after:max-w-[11rem] after:-translate-x-1/2 after:rounded-full after:bg-brand hover:bg-surface-raised-hover/35 light:bg-transparent light:text-slate-900 light:hover:bg-slate-100/60',
