...
const ProfileSettings = () => {
  ...
  if (!data) {
    return (
      <div className='bg-surface-nav/20 border-surface-border animate-pulse rounded-xl border p-8 text-center text-slate-500'>
        Loading...
      </div>
    );
  }
  ...
  const ProfileForm: FC<{ data: typeof data }> = ({ data: d }) => {
    ...
    return (
      <div className='space-y-6'>
        {/* Main Profile Info */}
        <section className='bg-surface-card border-surface-border rounded-xl border p-6 shadow-sm'>
        ...
        {/* Regions Settings */}
        <section className='bg-surface-card border-surface-border rounded-xl border p-6 shadow-sm'>
          <h4 className='type-h2 mb-4'>Display Regions</h4>
