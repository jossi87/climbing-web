  ...
  return (
    <div className='flex w-full items-center gap-2'>
      <div className='group relative flex-1'>
        <div className='group-focus-within:text-brand absolute top-1/2 left-3 -translate-y-1/2 text-slate-500 transition-colors'>
          <Video size={18} />
        </div>
        <input
          type='text'
      ...
      >
        <Plus size={16} />
        <span className={designContract.typography.label}>Add</span>
      </button>
    </div>
  );
};
