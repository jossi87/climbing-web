...
const markerBlueIcon = createLucideIcon(<MapPin size={14} fill='#3b82f6' color='white' />, '#3b82f6');
const markerRedIcon = createLucideIcon(<MapPin size={14} fill='#ef4444' color='white' />, '#ef4444');
