...
export default class AreaEdit extends Component {
  ...
  save(event) {
    ...
    .withCredentials()
    .field('json', JSON.stringify({id: this.state.id, visibility: this.state.visibility, name: this.state.name, comment: this.state.comment, lat: this.state.lat, lng: this.state.lng, newMedia: newMedia}))
