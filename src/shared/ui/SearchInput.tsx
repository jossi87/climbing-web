    ...
    <div className='group focus-within:ring-brand-border/70 relative w-full rounded-lg text-slate-400 transition-colors group-focus-within:text-slate-200 focus-within:ring-1'>
      ...
      {showClear ? (
        <button
          ...
          className='hover:bg-surface-raised-hover absolute top-1/2 right-1 z-10 flex h-8 w-8 -translate-y-1/2 items-center justify-center rounded-md text-slate-500 transition-colors hover:text-slate-200 focus-visible:ring-2 focus-visible:ring-slate-300/55 focus-visible:outline-none'
