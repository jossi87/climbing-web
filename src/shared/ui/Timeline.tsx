...
export const TimelineItem = ({
  ...
  <div className='group relative pl-8'>
    <div className='bg-surface-card border-surface-border group-hover:border-brand-border absolute top-1.5 left-0 z-10 h-4 w-4 rounded-full border-2 transition-colors' />
