...
const Sector = () => {
  ...
  return (
    <>
      ...
      {(data.areaAccessClosed || data.accessClosed) && <Message size="huge" negative icon="attention" header={(data.areaAccessClosed? "Area": "Sector") + " closed!"} content={(data.areaAccessClosed||'') + (data.accessClosed||'')} />}
      <Tab panes={panes} />
