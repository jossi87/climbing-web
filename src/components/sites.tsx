...
const Sites = () => {
  ...
  const map = <Leaflet height='85vh' outlines={outlines} defaultCenter={data.metadata.defaultCenter} defaultZoom={data.metadata.defaultZoom} history={history} markers={null} polylines={null} legends={null} onClick={null} onlyMap={false} showPhotoNotMap={false} />;
  return (
    <>
      <MetaTags>
