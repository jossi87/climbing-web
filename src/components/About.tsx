      ...
      <div className='grid grid-cols-1 lg:grid-cols-2 gap-8 items-start'>
        <div className='space-y-8'>
          <Card>
            ...
            <List>
              ...
              <ListItem>
                The aim is to provide the best possible climbing information in the region
              </ListItem>
              ...
              <ListItem>
                The owner of the content is linked to the origin, club or individual
              </ListItem>
            </List>
          </Card>
          ...
          <Card>
            ...
            <div className='space-y-5'>
              <p className='text-sm text-slate-300 leading-relaxed'>
                Contact <TextLink href='mailto:jostein.oygarden@gmail.com'>Jostein</TextLink> if you
                want to establish your own online guidebook for your region
              </p>
              <PriceDisplay
                currency='NOK'
                amount='250,- NOK'
                label='The yearly hosting fee (as of 2026) is'
              />
            </div>
          </Card>
        ...
        <Card>
          ...
          <Timeline>
            <TimelineItem
              year='2023'
              title='github.com/jossi87'
              description='The project is now open source'
            >
            ...
            <TimelineItem
              year='2021'
              title='is.brattelinjer.no'
              description='Ice climbing guide, by Jostein Øygarden'
            >
            ...
            <TimelineItem
              year='2016'
              title='buldreinfo.com'
              description='Bouldering guide, by Jostein Øygarden'
            >
            ...
            <TimelineItem
              year='2012-2016'
              title='buldreinfo.com'
              description='Bouldering guide, by Idar Ose'
            >
            ...
            <TimelineItem
              year='2006-2012'
              title='buldreinfo.com'
              description='Bouldering guide, by Vegard Aksnes'
            >
            ...
            <TimelineItem
              year='2003-2006'
              title='brv.no'
              description='Bouldering guide predecessor, by Vegard Aksnes'
            >
