...
const Problem = () => {
  ...
  if (markers.length>0) {
    ...
    panes.push({
      ...
      render: () => <Tab.Pane><Leaflet key={"sector="+data.id} autoZoom={true} height='40vh' markers={markers} outlines={outlines} polylines={polyline && [polyline]} defaultCenter={{lat: markers[0].lat, lng: markers[0].lng}} defaultZoom={16} history={history} onClick={null} /></Tab.Pane>
    });
  }
